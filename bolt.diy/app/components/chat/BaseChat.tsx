...
import { Menu, MENU_WIDTH } from '~/components/sidebar/Menu.client';
  ...
  (
    ...
    const baseChat = (
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row overflow-y-auto w-full h-full" style={{ marginLeft: 'var(--bolt-menu-offset)' }}>
